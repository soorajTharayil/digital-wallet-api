...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="glass-effect rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-2xl font-poppins font-bold text-gray-800"><?php echo e(session('user.name', 'User')); ?>!</h2>
                </div>
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center shadow-lg">
                    <span class="text-white font-bold text-xl"><?php echo e(substr(session('user.name', 'U'), 0, 1)); ?></span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <h3 class="text-4xl font-poppins font-bold">
                            <?php echo e(number_format($balance ?? 0, 2)); ?> <span class="text-lg"><?php echo e($currency ?? 'USD'); ?></span>
                        </h3>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <a href="<?php echo e(route('wallet.deposit.show')); ?>" 
        ...
        <a href="<?php echo e(route('wallet.withdraw.show')); ?>" 
           class="group glass-effect rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-4 mb-4">
        ...
        <a href="<?php echo e(route('wallet.transfer.show')); ?>" 
           class="group glass-effect rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-4 mb-4">
        ...
        <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 rounded-xl flex items-center justify-center <?php echo e($transaction['type'] === 'credit' ? 'bg-green-100' : 'bg-red-100'); ?>">
                            ...
                            <div>
                                <p class="font-semibold text-gray-800"><?php echo e($transaction['description'] ?? 'Transaction'); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e(\Carbon\Carbon::parse($transaction['created_at'])->format('M d, Y H:i')); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e($transaction['currency']); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('transactions.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <a href="<?php echo e(route('transactions.index')); ?>" class="inline-flex items-center text-indigo-600 hover:text-purple-600 font-semibold">
                        <span>View All Transactions</span>
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                        </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Desktop\wallet-api-github\resources\views/wallet/dashboard.blade.php ENDPATH**/ ?>