...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="glass-effect rounded-2xl shadow-2xl p-8">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <h2 class="text-2xl font-poppins font-bold text-gray-800">Transfer Funds</h2>
        </div>
        
        <form action="<?php echo e(route('wallet.transfer')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="mt-1 relative">
                    <input type="email" 
                           ...
                           id="recipient_email" 
                           required
                           class="block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-300 <?php $__errorArgs = ['recipient_email'];
...
unset($__errorArgs, $__bag); ?>
                <p class="mt-2 text-sm text-gray-500">Enter the email address of the recipient</p>
            </div>
...
unset($__errorArgs, $__bag); ?>" 
                          placeholder="Add a note about this transfer"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between pt-4">
                ...
                <button type="submit" 
                        class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                    <span>Transfer</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Desktop\wallet-api-github\resources\views/wallet/transfer.blade.php ENDPATH**/ ?>