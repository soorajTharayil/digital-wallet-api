        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8 space-y-6">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register.show')); ?>" class="font-semibold text-indigo-600 hover:text-purple-600 transition-colors">
                        Create one
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Desktop\wallet-api-github\resources\views/auth/login.blade.php ENDPATH**/ ?>