...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="glass-effect rounded-2xl shadow-2xl p-8">
        ...
        <form action="<?php echo e(route('wallet.deposit')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                          placeholder="Add a note about this deposit"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Desktop\wallet-api-github\resources\views/wallet/deposit.blade.php ENDPATH**/ ?>