        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8 space-y-6">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('login.show') }}" class="font-semibold text-indigo-600 hover:text-purple-600 transition-colors">
                        Sign in
                    </a>
                </p>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" required 
                           class="mt-1 block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-300 @error('name') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="default_currency" name="default_currency" 
                            ...
                            <option value="INR" {{ old('default_currency') == 'INR' ? 'selected' : '' }}>INR</option>
                    ...
                    <div>
                        ...
                        <input id="daily_debit_limit" name="daily_debit_limit" type="number" step="0.01" min="0" 
                               class="mt-1 block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-300" 
                               placeholder="Default" value="{{ old('daily_debit_limit') }}">
                        @error('daily_debit_limit')
