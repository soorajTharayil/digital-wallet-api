        ...
        <form action="{{ route('wallet.transfer') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1 relative">
                    <input type="email" 
                           ...
                           id="recipient_email" 
                           required
                           class="block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-300 @error('recipient_email') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror" 
            ...
            <div>
                ...
                <textarea id="description" 
                          ...
                          placeholder="Add a note about this transfer">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
